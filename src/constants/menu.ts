...
const MENU_ITEMS: MenuItemTypes[] = [
  ...
  {
    key: "jobtask-contracts",
    label: "Contracts",
    isTitle: false,
    icon: "book-open",
    url: "/jobtask/contracts",
  },
  {
    key: "jobtask-patients",
    label: "Patients",
    isTitle: false,
    icon: "user-plus",
    url: "/jobtask/patients",
  },
  {
    key: "jobtask-home-visits",
    label: "Home Visits",
    isTitle: false,
    icon: "home",
    url: "/jobtask/home-visits",
  },
  {
    key: "jobtask-roles-users",
    label: "Roles & Users",
    isTitle: false,
    icon: "users",
    url: "/jobtask/roles-users",
    children: [
      {
        key: "roles",
        label: "Roles",
        url: "/jobtask/roles",
        parentKey: "jobtask-roles-users",
      },
      {
        key: "users",
        label: "Users",
  ...
  {
    key: "jobtask-settings",
    label: "Settings",
    isTitle: false,
    icon: "settings",
    url: "/jobtask/settings",
  },
