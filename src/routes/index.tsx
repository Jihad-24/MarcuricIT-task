...
// Job Task
import Contracts from "../pages/JobTask/Contracts/Contracts";
import HomeVisits from "../pages/JobTask/HomeVisits/HomeVisits";
import Patients from "../pages/JobTask/Patients/Patients";
import Roles from "../pages/JobTask/Roles&Users/Roles/Roles";
import Users from "../pages/JobTask/Roles&Users/Users/Users";
import Settings from "../pages/JobTask/Settings/Settings";
...
const contractsAppRoutes: RoutesProps = {
...
const patientsAppRoutes: RoutesProps = {
...
const homeVisitsAppRoutes: RoutesProps = {
...
const rolesUsersAppRoutes: RoutesProps = {
  path: "/jobtask/roles-users",
  name: "Roles & Users",
  route: PrivateRoute,
  roles: ["Admin"],
  icon: "users",
...
const settingsAppRoutes: RoutesProps = {
